...
export default function App() {
  ...
  if (isLoading) return <SafeAreaView style={[styles.safeArea, styles.centered]}><ActivityIndicator size="large" color="#1f4d3b" /><Text style={styles.loadingText}>Connecting to LwayLway API...</Text></SafeAreaView>;
